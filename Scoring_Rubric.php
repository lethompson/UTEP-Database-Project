...
<form method="post" action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>">
        <table class="table" method="post" action="<?php echo htmlspecialchars( $_SERVER['PHP_SELF'] ); ?>">
            <thead>
                ...
                <tr>
                  <th>Student Name: <input type="text" name="student_name" maxlength="20" size="60" placeholder="Student Name"></th>
                  <th colspan="5">Teacher Name: <input type="text" name="teacher_name" maxlength="20" size="60" placeholder="Teacher Name"></th>
                </tr>
                <tr>
